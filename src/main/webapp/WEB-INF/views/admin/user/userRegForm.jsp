	...
	<div class="rit_wrapper">
		...
		<div class="rit_wrapper_w">
			...
			<div class="tit_location_section fix">
				<h3 class="sub_tit_h3">고객 관리<img src="../images/sub_common/ico_dot2.png" class="title_top1"/>
								 &nbsp;&nbsp; 등록</h3>
			</div>
			<!--/tit_location_section-->
						...
						<div class="btm_list_wrap">
							<p class="btn_section fix">
								<span class="lft_btn_section">
									<a class="btn1_ty0" href="#"><em>삭제</em></a>
								</span>
								<span class="rit_btn_section">
									<a class="btn1_ty4" href="#"><em>저장</em></a> <a
									class="btn1_ty5" href="/adminUserList"><em>목록</em></a>
								</span>
							</p>
						</div>
						<!-- // 버튼 영역-->
