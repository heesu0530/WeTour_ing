							...
							<table cellspacing="0" cellpadding="0" border="0" summary="게시판 뷰"
								...
								<tbody>
									<c:if test='${ssKey.mem_role=="admin"}'>
										<tr>
											<th>No.</th>
											<td><input type="text" id="notice_no" name="notice_no"
												class="input_text" value="${notice.notice_no}"
												readonly="readonly"></td>
											<th>공지사항등급</th>
											<td><input type="text" id="state_urgency"
												name="state_urgency" class="input_text"
										...
										<td style="width: 30%;">
											...
											<div>
												...
												<script>
													...
													';
																		document
																				.getElementById('modi_date').value = now;
																	});
												</script>
											</div>
										</td>
							...
							<div class="btm_list_wrap">
									<p class="btn_section fix">
										<span class="rit_btn_section">
											<button type="submit" class="btn1_ty1" name="update" value="수정완료">
											</button>
											<button>
												<a class="btn1_ty3" href="/BoardNoticeList">목록</a>
											</button>
										</span>
									</p>
							</div>
