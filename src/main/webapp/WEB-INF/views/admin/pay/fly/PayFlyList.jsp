	...
	<div class="rit_wrapper">
		...
		<div class="rit_wrapper_w">
			...
			<div class="tit_location_section fix">
				<h3 class="sub_tit_h3">결제관리<img src="../images/sub_common/ico_dot2.png" class="title_top1"/>
								 &nbsp;&nbsp;결제 현황 <img src="../images/sub_common/ico_dot2.png" class="title_top1"/>
								 &nbsp;&nbsp; 항공</h3>
			</div>
			<!--/tit_location_section-->
						...
						<fieldset>
							...
							<div class="search_board_section">
								<div class="search_board_form">
									<ul class="fix">
										<li><strong>· 검색조건</strong> <select id="cate_cd" name="cate_cd" class="select_type1">
									...
									<ul class="fix">
										...
										</select> <input type="text" placeholder="검색어를 입력해 주세요" class="input_text_n" style="width: 200px"></li>
									</ul>
					...
					<div class="con_list_wrap">
						...
						<div class="btm_list_wrap">
							...
							<p class="btn_section fix">
								...
								<span class="rit_btn_section"> <a class="btn1_ty3" href="/adminPayRegForm"><em>등록</em></a>
